...
Usa ${prefix}verify para verificarte y poder usar el bot🤖🇲🇹.`
				...
				num = anu.participants[0]
				teks = `Se fue un gay @${num.split('@')[0]} Menos mal se fue ya lo queria sacar :v porfavor ni buelvas😹`
				Lxa.sendMessage(mdata.id, teks, MessageType.text, {contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
...
//---Metadata stiker
			function addMetadata(packname, author) {	
				if (!packname) packname = '🇲🇹🤖Malta bot🤖🇲🇹  Admin'; if (!author) author = 'Bot-ketzakot';	
...
‣ Numero del Editor wa.me/+549357665-1536 
‣ RCT MALTA https://chat.whatsapp.com/BrrcQTYhI8iECAEk51etrg
